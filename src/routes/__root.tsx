...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Homie conecta tu hogar con prestadores de confianza: limpieza, técnicos, belleza, mascotas y más." },
      { name: "author", content: "Homie" },
      { property: "og:title", content: "Homie — Tu hogar, en buenas manos" },
      { property: "og:description", content: "Homie conecta tu hogar con prestadores de confianza: limpieza, técnicos, belleza, mascotas y más." },
      { property: "og:site_name", content: "Homie" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Homie — Tu hogar, en buenas manos" },
      { name: "twitter:description", content: "Homie conecta tu hogar con prestadores de confianza: limpieza, técnicos, belleza, mascotas y más." },
